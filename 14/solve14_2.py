...
cavemap = {}
maxy = 0 # Agora a nova interpretação é que este valor ajuda a encontrar o chão da caverna (não tem abismo)
...
while(True):
    ...
    while(True):
        ...
        # OK, não tem como descer mais. Coloca o grão aqui.
            ...
            count_sands += 1
            break
    # Se é o ponto inicial, terminamos o monte.
    if( sy == 0 ):
        break
